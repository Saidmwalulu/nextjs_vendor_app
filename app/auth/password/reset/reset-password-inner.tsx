      ...
      <div className="w-full max-w-sm">
        ...
        >
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="grid gap-2 mt-5">
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium transition-all duration-200 hover:shadow-lg transform hover:scale-[1.02]"
                >
            ...
            <Button
              variant="outline"
              className="w-full hover:shadow-lg transform hover:scale-[1.02] mt-4"
            >
              <Link href="/auth/forgot-password" className="text-blue-700 text-sm">
